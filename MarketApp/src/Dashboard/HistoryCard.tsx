            ...
            <Table stickyHeader size="small">
              <TableHead>
                <TableRow sx={{
                  ...
                  <TableCell>Результати</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {history.map((item, index) => (
                  ...
                  >
                    ...
                    <TableCell>
                      {item.output[0] && (
                        <Stack spacing={0.5}>
                          {Object.entries(item.output[0]).slice(0, 2).map(([key, value]) => (
                          ...
                          {Object.entries(item.output[0]).length > 2 && (
                            <Typography variant="caption" color="text.secondary">
                              + ще {Object.entries(item.output[0]).length - 2} показників
                            </Typography>
                          )}
                        </Stack>
                      )}
